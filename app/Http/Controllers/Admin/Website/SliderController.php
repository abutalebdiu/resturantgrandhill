...
class SliderController extends Controller
{
    ...
    public function index()
    {
        ...
        return  view('backend.Admin.website.slider.index',compact('sliders'));
    }
    ...
    {
       return view('backend.Admin.website.slider.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.Admin.website.slider.edit',$data);
    }
