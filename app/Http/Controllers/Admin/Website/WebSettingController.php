...
class WebSettingController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        return view('backend.Admin.website.website.view',$data);
    }
    ...
    {
         $data['setting'] = WebSetting::find(1);
         return view('backend.Admin.website.website.edit',$data);
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('admin.website.setting.index')->with($notification);
