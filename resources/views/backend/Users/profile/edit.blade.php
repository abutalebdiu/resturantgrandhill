        ...
        <div class="col-xl-6">
            <div class="panel panel-inverse" data-sortable-id="form-stuff-10">
                ...
                <div class="panel-body">
                    <form action="{{ route('user.user.profile.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <a class="btn btn-sm btn-default" href="{{ route('user.user.profile') }}">Back Profile</a>
