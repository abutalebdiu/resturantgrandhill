 ...
 <div id="content" class="content">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">All Agency</h4>
                    ...
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="" class="btn btn-primary btn-sm agencysmodel" data-id={{ $user->id }}  > <i class="fa fa-eye"></i> Show</a>
...
@section('customjs')
    ...
    <script>
         ...
         //=====================================================================================
            $(document).on('click','.agencysmodel',function(e){
                e.preventDefault();
