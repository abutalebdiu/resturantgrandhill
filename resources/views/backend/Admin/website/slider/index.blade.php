    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <a href="{{ route('admin.slider.create') }}" class="btn btn-primary btn-sm float-right mb-1" id="create-new-class"><i class="fa fa-plus"></i> Add Slider </a>
                    ...
                    @foreach($sliders as $slider)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('admin.slider.edit',$slider->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</a>
                                <a href="{{route('admin.slider.destroy',$slider->id)}}" id="delete" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delate</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
